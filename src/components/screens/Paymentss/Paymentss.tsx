            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
              ...
              <div className="payment-card_pay">
                ...
                <div className="card-bodyy_pay">
                  ...
                  <ul>
                    <li><GrainIcon className="ion" /><i><p className="lead ">7 days Trail</p></i></li>
                    <li><GrainIcon className="ion" />Build interactive templates</li>
                    <li><GrainIcon className="ion"/>Access to a public template library</li>
                    <li><GrainIcon className="ion"/>Add critical questions</li>
                    <li><GrainIcon className="ion"/>Complete your notes with the patient in the room</li>
                    <li><GrainIcon className="ion" />Easy Medicare compliance</li>
                    <li><GrainIcon className="ion"/>Cancel anytime</li>
                    <li><GrainIcon className="ion"/>Prompt support at the click of a button</li>
                    <li></li>
                    <li></li>
                    <li></li>
                  </ul>
            ...
            <Bounce>
              <div className="payment-card_pay">
                ...
                <center>
                  ...
                  <ul>
                    <li><GrainIcon className="ion" /><i><p className="lead ">30 days Trail</p></i></li>
                    <li><GrainIcon className="ion" />Build interactive templates</li>
                    <li><GrainIcon className="ion"/>Access to a public template library</li>
                    <li><GrainIcon className="ion"/>Add critical questions</li>
                    <li><GrainIcon className="ion"/>Complete your notes with the patient in the room</li>
            ...
            <Bounce right>
              <div className="payment-card_pay">
                ...
                <center>
                  ...
                  <ul>
                    <li><GrainIcon className="ion" /><i><p className="lead ">1 Year Trail</p></i></li>
                    <li><GrainIcon className="ion" />Save $$$</li>
                    <li><GrainIcon className="ion" />Build interactive templates</li>
                    <li><GrainIcon className="ion"/>Access to a public template library</li>
                    <li><GrainIcon className="ion"/>Add critical questions</li>
                    <li><GrainIcon className="ion"/>Complete your notes with the patient in the room</li>
